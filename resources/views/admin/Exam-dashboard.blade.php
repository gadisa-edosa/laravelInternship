...
@section('space-work')
<h2 class="mb-4">Quiz</h2><!-- Button trigger modal -->
    ...
    <tbody>
        <tr>
            ...
            <tr>
                ...
                <td>
                  <button type="button" class="addQuestion" data-id="{{ $exam->id }}" data-toggle="modal" data-target="#addQnaModal">Add Question</button>
                </td>
                <td>
                  <a href="#" class="seeQuestions" data-id="{{ $exam->id }}" data-toggle="modal" data-target="#seeQnaModal">See Question</button>
                </td>
                <td>
      ...
      <div class="modal-content">
        ...
        <form id="addExam">
              ...
              <div class="modal-body">
                  <label >Quiz</label>
                  <input type="text" name="exam_name" placeholder="Enter Quiz name" class="w-100" required><br><br>
